...
public class C01_LambdaExpression {
    ...
    /*
    1) Lambda "Functional Programming"-->method(action) kullanan pr dili.
...
*/
    public static void main(String[] args) {
        ...
        //task 01->  "Structured Programming"--> CINCIX Programming kullanarak list elemanlarını aynı satırda aralarında bosluk olacak şekilde print ediniz.
        ...
        System.out.println("\n***** Lambda 01 *****");
        sayiList.stream().forEach(System.out::print);
        System.out.println("\n***** Lambda 02 *****");
        sayiList.stream().forEach(SeedMethods::intYazdir);
    ...
    private static void printElFunctional(List<Integer> sayiList) {
        ...
        forEach((t)-> System.out.print(t+" ")); //akistaki coll. her bir elemani print edildi.
        /*
    ...
    private static void printElFunctional1(List<Integer> sayiList) {
        sayiList. // action 'a girecek akis kaynagi call edildi.
                stream(). // call edilen collection elemanlari akisa alindi.
                forEach(System.out::print); //akistaki coll. her bir elemani method refere edilerek print edildi.
    }
    private static void printElFunctional2(List<Integer> sayiList) {
        sayiList. // action 'a girecek akis kaynagi call edildi.
                stream(). // call edilen collection elemanlari akisa alindi.
                forEach(SeedMethods::intYazdir); //akistaki coll. her bir elemani method refere edilerek print edildi.
    }
